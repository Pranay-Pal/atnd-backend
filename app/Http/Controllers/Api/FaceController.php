...
class FaceController extends Controller
{
    ...
    public function match(Request $request): JsonResponse
    {
        ...
        // 'g' is little-endian float32, to match standard Float32List buffers generated by Flutter
        $queryVec = array_values(unpack('g512', $queryBytes));
        ...
        foreach ($candidates as $candidate) {
            ...
            $vec = array_values(unpack('g512', $raw));
